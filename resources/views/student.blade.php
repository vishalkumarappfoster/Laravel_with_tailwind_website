...
<div class="bg-gray-100">
  ...
  <table class="table-auto border-collapse border border-gray-300">
    ...
    <a href="{{ route('download.cv', $student->id) }}" class="btn btn-primary">Download CV</a>
</td>

        
        <td class="border px-4 py-2">
    <a href="{{ route('students.edit', $student->id) }}" class="hover:bg-green-500">Edit</a>
</td>
    ...
    <form action="{{ route('students.destroy', $student->id) }}" method="POST">
        @csrf
        @method('DELETE')
        <button type="submit" class="hover:bg-red-500" onclick="return confirm('Are you sure you want to delete this student?')">Delete</button>
    </form>
</td>
